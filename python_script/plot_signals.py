...
fig_u, axs_u = plt.subplots(3, 1, sharex=True)
...
axs_u[2].plot(n_u, mau)
axs_u[2].set_title("Cleaned Signal + Moving Average")
axs_u[2].set_xlabel("Iteration")
axs_u[2].set_ylabel("Signal Value")
axs_u[2].grid(True)
...
fig_g, axs_g = plt.subplots(3, 1, sharex=True)
...
axs_g[2].plot(n_u, mag)
axs_g[2].set_title("Cleaned Signal + Moving Average")
axs_g[2].set_xlabel("Iteration")
axs_g[2].set_ylabel("Signal Value")
axs_g[2].grid(True)
